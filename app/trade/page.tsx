                  ...
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-xs text-gray-500">Échanges de services</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <h4 className="text-sm font-medium text-gray-900">Produits</h4>
                        <p className="text-xs text-gray-500">Échanges de produits</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 border border-gray-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <h4 className="text-sm font-medium text-gray-900">Monétaire</h4>
                        <p className="text-xs text-gray-500">Transactions financières</p>
                      </div>
                    </div>
                  </div>
                </div>
