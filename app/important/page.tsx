            ...
            <div className="bg-white shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="text-center py-8">
                  ...
                  <h3 className="mt-2 text-sm font-medium text-gray-900">Aucune urgence</h3>
                  <p className="mt-1 text-sm text-gray-500">
                    Aucune information urgente à afficher.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  <div className="p-4 border border-red-200 rounded-lg bg-red-50">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        <h4 className="text-sm font-medium text-gray-900">Critique</h4>
                  ...
                  <div className="p-4 border border-amber-200 rounded-lg bg-amber-50">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-xs text-gray-500">Action requise rapidement</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-4 border border-blue-200 rounded-lg bg-blue-50">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-xs text-gray-500">À noter</p>
                      </div>
                    </div>
                  </div>
                </div>
